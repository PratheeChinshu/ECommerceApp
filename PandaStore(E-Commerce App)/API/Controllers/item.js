...
module.exports.AddItem= async (req, res, next) => {
    try {
      const {item_name,item_type,description,price,size,manufacturer,item_image} = req.body;
      const item = await User.create({ item_name,item_type,description,price,size,manufacturer,item_image });
      res
        .status(201)
  ...
  // http://localhost:4000/item/:item_type
